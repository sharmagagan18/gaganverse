...
export default function Portfolio() {
  ...
  const copyEmail = async () => {
    const email = "18sharmagagan@gmail.com";
    try {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#070816] text-[#f6f3ff] selection:bg-violet-500 selection:text-white">
      ...
      <PortfolioChrome />
      <nav aria-label="Primary navigation" className={`fixed inset-x-0 top-3 z-50 mx-auto w-[calc(100%-1.25rem)] max-w-7xl rounded-2xl border border-white/10 bg-[#070816]/80 shadow-2xl backdrop-blur-2xl transition-transform duration-500 sm:w-[calc(100%-2rem)] ${navVisible ? "translate-y-0" : "-translate-y-28"}`}>
      ...
      <section id="home" className="relative min-h-screen overflow-hidden pt-20">
        ...
        <img src="/assets/hero-portal.png" alt="Abstract luminous digital portal" fetchPriority="high" className="absolute inset-0 h-full w-full object-cover opacity-80" />
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.12fr_.88fr] lg:py-24">
          <div className="hero-enter max-w-4xl">
            ...
            <div className="mt-7 flex h-8 items-center gap-3 text-base font-semibold text-slate-300 sm:text-lg">
              <span className="typing-line">Full-stack focus. Complete websites. Real usability.</span><span className="typing-caret" aria-hidden="true" />
            </div>
            <p className="mt-3 max-w-xl text-sm leading-7 text-slate-400 sm:text-base">
              Computer Science Engineering student focused on building complete, responsive web experiences—from thoughtful interfaces to reliable application logic.
            </p>
          ...
          <div className="hero-enter-delay relative mx-auto w-full max-w-md lg:ml-auto">
            <div data-tilt className="glass-profile relative rounded-[2.2rem] border border-white/15 bg-[#0b0d20]/75 p-5 shadow-2xl backdrop-blur-xl sm:p-7">
              ...
              <div className="mt-7 space-y-3 border-t border-white/10 pt-6 text-sm text-slate-300">
                ...
                <div className="flex items-center gap-3"><Sparkles className="h-4 w-4 text-violet-300" />Full-stack focused builder</div>
              </div>
      ...
      <section id="about" className="relative mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:py-32">
        <Reveal>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_.8fr] lg:gap-16">
            <div>
              <h2 className="section-title">Curious mind.<br /><span className="text-violet-300">Complete builder.</span></h2>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300">
                I&apos;m a Computer Science Engineering student focused on full-stack development, with hands-on experience building responsive web applications. I care about taking websites from idea to complete experience while continuously sharpening my technical skills through projects and internships.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="code-window col-span-2 rounded-[1.7rem] border border-white/10 bg-[#090b18] p-5 font-mono text-xs leading-6 text-slate-400">
                <div className="mb-3 flex gap-1.5" aria-hidden="true"><i className="bg-rose-400" /><i className="bg-amber-300" /><i className="bg-emerald-400" /></div>
                <p><span className="text-violet-300">const</span> developer = &#123;</p>
                <p className="pl-4">focus: <span className="text-cyan-300">&quot;complete web products&quot;</span>,</p>
          ...
          <Reveal>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[.88fr_1.12fr] lg:gap-16">
              <div data-tilt className="skill-orbit relative rounded-[2.2rem] border border-white/10 bg-[#10142b] p-3">
                <img src="/assets/dev-workspace.png" alt="Abstract development workspace" loading="lazy" decoding="async" className="aspect-square w-full rounded-[1.7rem] object-cover" />
                <div className="absolute bottom-7 left-7 rounded-2xl border border-white/15 bg-[#090b1b]/85 px-4 py-3 backdrop-blur-md">
                  ...
                  <p className="mt-1 font-bold">Complete web experiences</p>
                </div>
              ...
              <div>
                <h2 className="section-title">Tools I use to turn<br /><span className="text-cyan-300">ideas into products.</span></h2>
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  <div className="skill-mini-card"><Code2 /><span>Full-stack focus</span></div>
          ...
          <div className="overflow-hidden rounded-[2.4rem] border border-violet-300/20 bg-[#11142c] p-7 shadow-[0_0_80px_rgba(109,94,247,0.13)] sm:p-12 lg:p-16">
            <div className="grid items-end gap-10 lg:grid-cols-[1.2fr_.8fr]">
              ...
              <div className="space-y-3">
                ...
                <button onClick={copyEmail} className="contact-link w-full text-left"><Copy /><span aria-live="polite"><small>Quick action</small>{copied ? "Email copied!" : "Copy email address"}</span>{copied ? <Check className="text-emerald-300" /> : <ArrowUpRight />}</button>
              </div>
            </div>
          </div>
        </Reveal>
